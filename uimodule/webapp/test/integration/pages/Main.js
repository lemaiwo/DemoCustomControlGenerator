sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/actions/Press"], function (Opa5, Press) {
    ...
    const sViewName = "be.wl.DemoCustomControlGenerator.view.MainView";
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of be.wl.DemoCustomControlGenerator",
                        },
                        success: function () {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title be.wl.DemoCustomControlGenerator",
                    });
                },
            },
        },
